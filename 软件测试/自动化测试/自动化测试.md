...
![image-20221026094950071](image-20221026094950071.png)
...
![image-20221026095423400](image-20221026095423400.png)
...
![image-20221026095729734](image-20221026095729734.png)

> 2）选取未知节点：xpath通配符可用来选取未知的XML元素，xpath通配符及其描述，如表所示。

![image-20221026095747661](image-20221026095747661.png)

![image-20221026095757202](image-20221026095757202.png)

> 3）选取若干路径：通过在路径表达式中使用“|”运算符，可以选取若干路径。在表中列出了一些路径表达式及其结果。

![image-20221026095834596](image-20221026095834596.png)
...
![image-20221026095859089](image-20221026095859089.png)
...
![image-20221026095955998](image-20221026095955998.png)
...
![image-20221026100033560](image-20221026100033560.png)
...
![image-20221026100133687](image-20221026100133687.png)
...
![image-20221026100209167](image-20221026100209167.png)
...
![image-20221026100253396](image-20221026100253396.png)
...
![image-20221026100331104](image-20221026100331104.png)
...
![image-20221026100504713](image-20221026100504713.png)
...
![image-20221026100726333](image-20221026100726333.png)
...
![image-20221026104123086](image-20221026104123086.png)
...
![image-20221026104226339](image-20221026104226339.png)

![image-20221026104245875](image-20221026104245875.png)
...
![image-20221027134238427](image-20221027134238427.png)

# submit()方法使用

![image-20221026104351337](image-20221026104351337.png)
...
![image-20221026104458800](image-20221026104458800.png)
...
![image-20221026104728402](image-20221026104728402.png)

![image-20221026104737793](image-20221026104737793.png)
...
**针对select/option这样下拉选择框，如图展示：![img](20210312190450849.png)，我们可以直接使用webdriver中的\**Select\**类去处理 。**
...
![img](watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0xJRkVORzA0MDI=,size_16,color_FFFFFF,t_70.png)

**源码中\**Select\**下有很多方法，专门用于处理下拉选择框操作：**

![img](watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0xJRkVORzA0MDI=,size_16,color_FFFFFF,t_70-16668556110361.png)
...
- ### select_by_visible_text：选择所有显示与参数匹配的文本的选项。
  ...
  例如：图片标蓝框处的文本信息 ![img](20210312182917162.png)，select_by_visible_text("Audi")，选择的就是第四个：" <option value="audi">Audi</option> "
...
![image-20221026105024607](image-20221026105024607.png)

![image-20221026105057491](image-20221026105057491.png)
...
![image-20221026105515248](image-20221026105515248.png)
...
####  [python数据处理之 ddt，@data， @unpack](https://www.cnblogs.com/nbnuan/articles/10656724.html)
...
![image-20221026205806485](image-20221026205806485.png)
...
![image-20221027154049469](image-20221027154049469.png)

**(注：下划线的作用)**

**来自**：[Python中下划线的5种含义 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/36173202)

![img](v2-cbc5c6037101c7d33cf0acd9f00a8cfa_r.jpg)

**(注：*号的作用)**

来自：[Python3中* 和 ** 运算符的用法是什么-Python教程-PHP中文网](https://www.php.cn/python-tutorials-474944.html)
...
![image-20221027212316786](image-20221027212316786.png)
...
![image-20221028102848155](image-20221028102848155.png)

![image-20221028102955027](image-20221028102955027.png)
...
- 也不用`base_dir=base_dir.replace('\\','/')`转换
  ...
  **`for index,row in enumerate(reader,1):`是什么意思**
  ...
  ![image-20221028103723325](image-20221028103723325.png)

**总而言之enumerate就是[枚举](https://so.csdn.net/so/search?q=枚举&spm=1001.2101.3001.7020)的意思，把元素一个个列举出来，第一个是什么，第二个是什么，所以他返回的是元素以及对应的索引。**
